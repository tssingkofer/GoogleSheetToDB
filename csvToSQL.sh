...
do
	...
	SELECT * FROM (SELECT curdate() as a, '$f1' as sw,'$f2' as b,'$f3' as c,'$f4' as d,'$f5' as e,'$f6' as f,'$f7' as g,'$f8' as h,'$f9' as i,'$f10' as j,'$f11' as k,'$f12' as l,'$f13' as m,'$f14' as ew,'$15' as n,'$f16' as o,'$f17' as p) as tmp WHERE (Select count(*) from trips where start_map='$f4') = '0';" >> ./insertSQL.sql
